...
const entries = computed(() => Object.entries(props.mappings))
</script>
  ...
  <div class="border border-gray-200 rounded overflow-hidden bg-white" data-testid="input-mapping-grid">
    <table class="w-full text-sm">
      <thead class="bg-gray-50 text-xs uppercase text-gray-500">
        <tr>
          <th class="text-left px-3 py-2 w-1/3">Field</th>
          <th class="text-left px-3 py-2">Mapped Value</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr
          ...
          :data-testid="`input-mapping-grid-row-${field}`"
        >
