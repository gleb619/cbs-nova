...
fun main() {
    ...
    println(
        "DSL compiled successfully. Workflows: ${registry.workflows.size}, Events: ${registry.events.size}, Transactions: ${registry.transactions.size}, MassOps: ${registry.massOperations.size}",
    )
}
