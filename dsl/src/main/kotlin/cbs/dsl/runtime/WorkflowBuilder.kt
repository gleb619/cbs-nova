...
class WorkflowBuilder(
    ...
    override val states: List<String> get() = inferredStates()
    override val initial: String get() = inferredInitial()
    override val terminalStates: List<String> get() = inferredTerminal()
}

fun workflow(
    code: String,
    block: WorkflowBuilder.() -> Unit,
): WorkflowDefinition = WorkflowBuilder(code).apply(block)
