...
class DslRegistry {
    ...
    val workflows: Map<String, WorkflowDefinition> get() = _workflows.toMap()
    val events: Map<String, EventDefinition> get() = _events.toMap()
    val transactions: Map<String, TransactionDefinition> get() = _transactions.toMap()
    val massOperations: Map<String, MassOperationDefinition> get() = _massOperations.toMap()
    val helpers: Map<String, HelperDefinition> get() = _helpers.toMap()
    val conditions: Map<String, ConditionDefinition> get() = _conditions.toMap()
    ...
    private fun <T> MutableMap<String, T>.registerChecked(
        code: String,
        value: T,
    ) {
