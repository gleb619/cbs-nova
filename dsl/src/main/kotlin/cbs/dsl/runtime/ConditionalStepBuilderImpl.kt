...
class ConditionalStepBuilderImpl : ConditionalStepBuilder {
    ...
    override fun `when`(predicate: () -> Boolean): ConditionalStepBuilder.WhenClause = WhenClauseImpl(predicate)

    override infix fun orWhen(predicate: () -> Boolean): ConditionalStepBuilder.WhenClause = WhenClauseImpl(predicate)
