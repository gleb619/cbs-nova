...
class DslSampleParameterizedTest {
    ...
    fun `shouldCompileSuccessfullyWhenScenarioIsValid`(
        ...
        assertTrue(result is CompileResult.Success, "Compile failed for '$name': ${(result as? CompileResult.Failure)?.errors}")
        ...
        fun scenarios(): Stream<Arguments> =
            Stream.of(
                ...
                Arguments.of(
                    ...
                    { reg: DslRegistry -> assertTrue(reg.conditions.containsKey("BORROWER_ACCOUNT_READY")) },
                ),
                Arguments.of(
                ...
                Arguments.of(
                    ...
                    { reg: DslRegistry -> assertTrue(reg.events["INLINE_EVENT"]!!.transactionsBlock != null) },
                ),
                Arguments.of(
                ...
                Arguments.of(
                    ...
                    { reg: DslRegistry ->
                        ...
                        assertTrue(massOp.triggers.any { it is cbs.dsl.api.TriggerDefinition.CronTrigger })
                    },
                ),
                Arguments.of(
                    ...
                    { reg: DslRegistry ->
                        ...
                        assertTrue(massOp.triggers.any { it is cbs.dsl.api.TriggerDefinition.SignalTrigger })
                    },
                ),
                Arguments.of(
                    "chained-helpers",
                ...
                Arguments.of(
                    ...
                    { reg: DslRegistry -> assertTrue(reg.events["BRANCHING_EVENT"]!!.transactionsBlock != null) },
                ),
                Arguments.of(
                    "full-loan-contract",
