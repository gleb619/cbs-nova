...
/**
 * Listener for tracking external API-related external calls.
 * Logs external API operations and can be extended to capture detailed metrics.
 */
@Component
public class ExternalApiCallListener implements ExternalCallListener {
  ...
  public void onCall(@NonNull String type, @NonNull String target, @NonNull String operation, @Nullable Object payload) {
    ...
    LOGGER.info("EXTERNAL API CALL - Operation: {}, Target: {}, Payload: {}", operation, target, payload);
