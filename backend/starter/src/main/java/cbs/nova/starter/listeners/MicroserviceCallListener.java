...
/**
 * Listener for tracking microservice-related external calls.
 * Logs microservice operations and can be extended to capture detailed metrics.
 */
@Component
public class MicroserviceCallListener implements ExternalCallListener {
  ...
  public void onCall(@NonNull String type, @NonNull String target, @NonNull String operation, @Nullable Object payload) {
    ...
    LOGGER.info("MICROSERVICE CALL - Operation: {}, Target: {}, Payload: {}", operation, target, payload);
