...
/**
 * Typed decorator around a real {@link CallableStatement}. Inherits all recording and delegation
 * behaviour from {@link RecordingPreparedStatement} and delegates the OUT-parameter API of
 * {@link CallableStatement} directly to the real statement.
 */
public class RecordingCallableStatement extends RecordingPreparedStatement
        implements
          CallableStatement {
  ...
  public String toString() {
    return "RecordingCallableStatement[" + delegate + "]";
  }
}
