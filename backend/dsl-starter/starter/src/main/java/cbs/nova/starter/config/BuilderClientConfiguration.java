...
public class BuilderClientConfiguration {
  ...
  static JdkClientHttpRequestFactory jdkRequestFactory(DslBuilderClientProperties properties) {
  ...
  static HttpClient httpClient(DslBuilderClientProperties properties) {
