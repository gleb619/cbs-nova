...
class LoanDisbursementEventDslTest {
  ...
  @Test
  @DisplayName("should generate valid event activity interface")
  void shouldGenerateValidEventActivityInterface() throws Exception {
    Path activity =
        OUTPUT.resolve("cbs/dsl/codegen/generated/LoanDisbursementEventDslEventActivity.java");
  ...
  @Test
  @DisplayName("should generate valid event specification interface")
  ...
  @Test
  @DisplayName("should generate valid event specification implementation")
  void shouldGenerateValidEventSpecificationImplementation() throws Exception {
    Path impl =
        OUTPUT.resolve("cbs/dsl/codegen/generated/LoanDisbursementEventSpecificationImpl.java");
  ...
  @Test
  @DisplayName("should generate valid event definition")
  void shouldGenerateValidEventDefinition() throws Exception {
    Path def = OUTPUT.resolve(
        "cbs/dsl/codegen/generated/definitions/LoanDisbursementEventDslDefinition.java");
