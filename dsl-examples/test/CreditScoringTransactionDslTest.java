...
class CreditScoringTransactionDslTest {
  ...
  void shouldParseDslSourceAsValidImplicitClass() throws Exception {
    Path source = Path.of("src/CreditScoringTransactionDsl.java");
    ...
    assertTrue(parsed.body().contains("CREDIT_SCORING"));
  }

  @Test
  @DisplayName("should generate compiled class file")
  void shouldGenerateCompiledClassFile() {
    assertTrue(Files.exists(OUTPUT.resolve("CreditScoringTransactionDsl.class")));
  }
