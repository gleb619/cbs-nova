...
`/loop 30m docs/codex-loop.ignore.md`

Continuously identify small, high-value improvements across backend (Java / Temporal / DSL) and frontend (Vue / Nuxt / BFF), then feed them into `docs/kanban.md` as concrete `Backlog` tasks. No code execution here — this loop only proposes tasks.
