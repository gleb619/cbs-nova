...
| T23 | Done | Starter integration test | @SpringBootTest covering full path: configure source-dir → load DSL → preview + explain via DslRuntimeResource | Medium | TBD | - | T20 | `./docs/plans/T23-starter-integration-test.md` |
