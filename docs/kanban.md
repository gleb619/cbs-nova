...
| :- | :----- | :---- | :---------- | :------: | :---- | :----- | :--------- | :-------- |
| T24 | Backlog | MermaidDiagramGenerator | Real Mermaid flowchart from descriptor in Explain mode replacing placeholder | Medium | TBD | - | - | `./docs/plans/T24-mermaid-generator.md` |
...
| T27 | Backlog | REST error response standardization | Structured ErrorResponse JSON record on preview/run failure instead of bare string | Low | TBD | - | - | `./docs/plans/T27-error-response.md` |
