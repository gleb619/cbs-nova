...
| T53 | Backlog | Structured exception tracking with runId and exceptionId | Introduce runId on Context, exceptionId derived from runId in DslException root, stable DslErrorCode registry, and propagate through runtime/REST/logs. | High | loop | - | - | `./docs/plans/T53-structured-exception-tracking.md` |
