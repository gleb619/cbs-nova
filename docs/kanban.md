...
| :- | :----- | :---- | :---------- | :------: | :---- | :----- | :--------- | :-------- |
| T24 | Done | MermaidDiagramGenerator | Real Mermaid flowchart from descriptor in Explain mode replacing placeholder | Medium | TBD | - | - | `./docs/plans/T24-mermaid-generator.md` |
| T25 | Done | DSL introspection endpoints | GET /api/dsl/processes, /transactions, /helpers listing registered entity names | Medium | TBD | - | - | `./docs/plans/T25-introspection-endpoints.md` |
| T26 | Done | Spring PropertyResolver wiring | Auto-configure PropertyResolver bean from Spring Environment in starter | Low | TBD | - | - | `./docs/plans/T26-property-resolver.md` |
| T27 | Done | REST error response standardization | Structured ErrorResponse JSON record on preview/run failure instead of bare string | Low | TBD | - | - | `./docs/plans/T27-error-response.md` |
