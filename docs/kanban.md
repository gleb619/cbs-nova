...
| T54 | In Progress | Enrich dry-run/preview and explain responses | Extend preview and explain endpoints so they return structured reports with execution trace, external call details, call counts, and diagrams, enabling downstream report/diagram builders. | High | loop | - | - | `./docs/plans/T54-enrich-dry-run-preview-explain.md` |
