...
// `dsl-codegen/src/main/java/cbs/dsl/codegen/DslCodeGenerator.java` we generate some new service
// that extends from
// some our service, and call a some `dsl-api/src/main/java/cbs/dsl/api/TransactionFunction.java`
// implementation
