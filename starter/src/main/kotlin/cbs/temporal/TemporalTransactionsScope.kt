 ...
 * Temporal's Async.function() and Promise primitives.
 *
 * This scope maintains a context map for sharing data between transaction steps and tracks failure
...
class TemporalTransactionsScope(
  ...
  companion object {
    /**
     * Executes the suspend transactions block within the provided scope. Uses runBlocking with
     * Dispatchers.Unconfined to execute inline on the current Temporal workflow thread without
     * dispatching to a new thread.
     *
