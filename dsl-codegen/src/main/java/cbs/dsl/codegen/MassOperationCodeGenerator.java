...
public class MassOperationCodeGenerator {
  ...
  public MassOperationCodeGenerator(Function<RegistrationSpec, String> dslBodyProvider) {
    this(null, dslBodyProvider);
  }

  public MassOperationCodeGenerator(
      Filer filer, Function<RegistrationSpec, String> dslBodyProvider) {
